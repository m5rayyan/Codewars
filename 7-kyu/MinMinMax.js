...
// largest number in the array, and the smallest number between the two array
...
const minMinMax = (array) => {
  ...
  while (array.find((element) => element == minimumAbsent)) {
    minimumAbsent += 1;
  }
...
//   const max = Math.max(...array);
//   let add = 1;
//   while (array.find((element) => element == min + add)) {
//     add += 1;
//   }
//   const minimumAbsent = min + add;
//   return [min, minimumAbsent, max];
// };
